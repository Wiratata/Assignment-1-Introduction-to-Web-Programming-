...
const resultText = document.getElementById('convertResult');
...
if (fromSelect) {
  ...
  convertBtn.addEventListener('click', function () {
    ...
    resultText.textContent = `${Number(result.toFixed(2)).toString()}°${to}`;
  });
